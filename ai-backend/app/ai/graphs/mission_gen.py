...
from app.ai.prompts.mission_gen_manifest import (
...
def get_manifest_path(world_id: str) -> Path:
    ...
    # `content/worlds/` is now the six-phase generator's, and `app/manifests/loader.py`
    # validates every file it finds there against the function-signature schema. The
    # props-and-verbs manifests this generator reads live beside it instead.
    return backend_root / "content" / "worlds_legacy" / f"{world_id}.yaml"
