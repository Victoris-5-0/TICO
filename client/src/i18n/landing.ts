...
export const landingCopy = {
  en: {
    ...
    previewBody: "Your journey begins at the neighborhood bakery. Meet the world behind your first Python mission.",
    previewAction: "Explore the first mission",
  ...
  "ar-EG": {
    ...
    previewBody: "رحلتك بتبدأ من فرن العيش في الحي. اتعرّف على عالم أول مهمة بايثون ليك.",
    previewAction: "استكشف أول مهمة",
